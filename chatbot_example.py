...
openai.api_key = "sk-proj-ee7hLWdn3hVEtmSrJm4sT3BlbkFJjdAcyrokFgxf92StgVni"
#client = OpenAI(sk-proj-ee7hLWdn3hVEtmSrJm4sT3BlbkFJjdAcyrokFgxf92StgVni')
...
def create_prompt(df, query):
    ...
    system_role = f"""You are an artificial intelligence language model named "두이" that specializes in summarizing \
    and answering documents about AI data, developed by developers 사용자1 and 사용자2.
...
st.image('images/sophia_chatbot.png')
...
with st.form('form', clear_on_submit=True):
    user_input = st.text_input('데이터에 대해 물어보세요!', '', key='input')
